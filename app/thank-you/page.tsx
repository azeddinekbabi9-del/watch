...
export default async function ThankYouPage({
  ...
  return (
    <section className="luxury-page page-transition py-6 sm:py-10 md:py-14">
      <div className="relative container-page mx-auto max-w-4xl overflow-hidden rounded-md border border-gold/25 bg-[#090909] shadow-luxury">
        <div className="relative px-4 py-9 text-cream sm:px-5 sm:py-10 md:px-10">
        ...
        <div className="grid gap-5 p-4 sm:p-5 md:grid-cols-[minmax(0,1fr)_minmax(280px,0.85fr)] md:p-8">
          <div className="min-w-0 rounded-md border border-gold/20 bg-white/[0.045] p-4 shadow-sm sm:p-5">
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              <div className="rounded-md border border-gold/15 bg-black/25 p-4">
              ...
              <div className="rounded-md border border-gold/15 bg-black/25 p-4">
                ...
                <p className="mt-2 font-semibold capitalize text-cream">
            ...
            {order ? (
              <div className="mt-5 rounded-md border border-gold/15 bg-black/25 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-gold">
                  Order summary
                </p>
                  ...
                  {orderItems.map((item, index) => (
                    ...
                    >
                      <div className="min-w-0">
                        ...
                        <p className="text-cream/55">Quantity: {item.quantity}</p>
                      </div>
                ...
                <div className="mt-4 flex items-center justify-between border-t border-gold/15 pt-4">
                  <span className="text-sm font-semibold text-cream/60">Total</span>
          ...
          <aside className="rounded-md border border-gold/25 bg-black/35 p-5 text-cream shadow-soft">
